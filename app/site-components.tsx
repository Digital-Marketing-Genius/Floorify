...
export function Footer() {
  return <footer><div className="shell footer-grid"><div><a href="/" className="logo logo-light"><img src="/floorify-logo-cropped.png" alt="Floorify Canada" /></a><p>Thoughtful flooring guidance and professional installation for homes and businesses across Calgary and surrounding communities.</p></div><div><h3>Explore</h3><a href="/flooring">Flooring</a><a href="/services">Services</a><a href="/showroom">Showroom</a><a href="/about">About us</a></div><div><h3>Visit us</h3><a href="https://maps.app.goo.gl/r5ciYjbxDoyne1Uw9" target="_blank" rel="noreferrer"><p>100 Marina Dr #405<br/>Chestermere, AB T1X 0A9</p></a><p>Monday–Saturday<br/>10 a.m.–5 p.m.</p></div><div><h3>Talk to us</h3><a href="tel:+14034639833">+1 (403) 463-9833</a><a href="mailto:info@floorifycanada.ca">info@floorifycanada.ca</a><a href="https://wa.me/14034639833" target="_blank" rel="noreferrer">Chat on WhatsApp</a><a className="footer-cta" href="/#estimate">Book a free estimate →</a></div></div><div className="shell footer-bottom"><span>© {new Date().getFullYear()} Floorify Canada. All rights reserved.</span><div><a href="/privacy">Privacy</a><a href="/terms">Terms</a></div></div></footer>;
}
